  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "WhatsApp", href: "/documentation/integrations/whatsapp", active: true },
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl text-gray-400 leading-relaxed">
                Connect WhatsApp Business API to automate customer conversations and streamline support.
              </p>
            </div>
            ...
            <div className="space-y-12">
                ...
                <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-blue-100/80">
                    <li className="flex items-start space-x-3">
                      ...
                      <span>WhatsApp Business API account (not WhatsApp Business app)</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5" />
                      <span>Verified Facebook Business Manager account</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5" />
                      <span>Phone number dedicated to WhatsApp Business API</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5" />
                      <span>Business verification completed with Meta</span>
                    </li>
                  </ul>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-200/80 text-sm">
                          WhatsApp Business API setup can take 1-2 weeks for approval. We recommend starting 
                          the verification process early. Contact our support team for assistance with the setup process.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {[
                    {
                      ...
                      description: "Get your WhatsApp Business API account ready",
                      details: [
                        "Apply for WhatsApp Business API through Meta",
                        "Complete business verification process",
                        "Set up your phone number and messaging templates",
                    ...
                    {
                      step: 2,
                      title: "Connect to SalesPilot",
                      description: "Link your approved WhatsApp Business API with SalesPilot",
                      details: [
                        "Navigate to Integrations in your SalesPilot dashboard",
                        "Click 'Connect WhatsApp Business API'",
                        "Provide your WhatsApp Business API credentials",
                        "Authorize SalesPilot to access your WhatsApp account"
                      ],
                      time: "10 minutes"
                    },
                    {
                      ...
                      description: "Set up approved message templates for automation",
                      details: [
                        "Review your approved WhatsApp message templates",
                        "Map templates to SalesPilot automation triggers",
                        "Configure dynamic variables and personalization",
                        "Set up fallback responses for unmatched scenarios"
                      ],
                      time: "30 minutes"
                    },
                    {
                      ...
                      details: [
                        "Send test messages using the sandbox environment",
                        "Verify automation responses are working correctly",
                        "Check message delivery and read receipts",
                        "Enable live mode for production use"
                      ],
                      time: "15 minutes"
                    }
                  ].map((item) => (
                    <div key={item.step} className="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-start space-x-4">
                          <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center font-semibold">
                            {item.step}
                          </div>
                        ...
                        <div className="flex items-center space-x-1 text-sm text-gray-500 bg-gray-800 px-3 py-1 rounded-full">
              ...
              {/* Features */}
              <section>
                <h2 className="text-2xl font-bold text-gray-100 mb-8">WhatsApp Automation Features</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    {
                      title: "Message Templates",
                      description: "Use approved WhatsApp message templates for automated responses",
                      features: [
                        "Template management",
                        "Dynamic variables",
                    ...
                    },
                    {
                      ...
                      description: "Send images, documents, and interactive messages",
                      features: [
                    ...
                    },
                    {
                      ...
                      description: "Connect WhatsApp conversations with your business processes",
                      features: [
                    ...
                    },
                    {
                      ...
                      description: "Built-in compliance with WhatsApp Business policies",
                      features: [
              ...
              {/* Best Practices */}
              <section>
                <h2 className="text-2xl font-bold text-gray-100 mb-8">WhatsApp Best Practices</h2>
                <div className="space-y-6">
                  <div className="bg-green-900/20 border-l-4 border-green-500 p-6 rounded-r-xl">
                    ...
                    <ul className="space-y-2 text-green-300">
                      <li>• Use approved message templates for automated responses</li>
                      <li>• Respond to customer messages within 24 hours</li>
                      <li>• Provide clear opt-out instructions</li>
                      <li>• Keep messages conversational and helpful</li>
                      <li>• Use rich media to enhance customer experience</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-red-900/20 border-l-4 border-red-500 p-6 rounded-r-xl">
                    ...
                    <ul className="space-y-2 text-red-300">
                      ...
                      <li>• Don't use unapproved message templates</li>
                      <li>• Don't exceed WhatsApp rate limits</li>
                      <li>• Don't ignore customer requests to opt-out</li>
                      <li>• Don't send messages outside business hours without permission</li>
                    </ul>
                  </div>
                </div>
              </section>
                  ...
                  {[
                    {
                      ...
                      solution: "Check that your message template is approved and the recipient has opted in to receive messages from your business."
                    },
                    {
                      issue: "Rate limit exceeded",
                      solution: "WhatsApp has messaging limits based on your account tier. Contact WhatsApp support to increase your messaging limits or space out your automated messages."
                    },
                    {
                      issue: "Template not working",
                      solution: "Ensure your message template is approved by WhatsApp and matches exactly with the template format, including variables and formatting."
                    },
                    {
                      issue: "Connection issues",
                      solution: "Verify your WhatsApp Business API credentials are correct and your account is in good standing with Meta."
                    }
                  ].map((faq, index) => (
            ...
            <div className="mt-16 flex items-center justify-between p-6 bg-gray-900/50 rounded-xl border border-gray-800">
              ...
              >
                ...
                Previous: Instagram Integration
              </Link>
              <Link 
